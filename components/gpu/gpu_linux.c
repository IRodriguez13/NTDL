...
static int detect_nvidia_gpu(int gpu_index)
{
    ...
    if (fgets(line, sizeof(line), fp))
    {
        ...
        { // Al menos los campos básicos
            ...
            snprintf(gpu->driver_version,sizeof(gpu->driver_version), "%s", driver);    
            ...
            gpu->memory_usage_percent = (memory_total > 0) ? ((float)memory_used / memory_total * 100.0f) : 0.0f;
